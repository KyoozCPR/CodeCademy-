message = str(input("Please Enter The Message You Want to Decode: "))
keyword = str(input("Please Enter The Keyword To Decode The Message: "))
...
def vigenere_decoder(coded_message, keyword):
    ...
    for i in range(0,len(coded_message)):    
        if not coded_message[i] in punctuation:
            ...
            translated_message += alphabet[ln]
        else:
